description = "devslab-kit :: access (permissions/roles) public contracts"
...
mavenPublishing {
    ...
    pom {
        name.set("devslab-kit-access-api")
        description.set("devslab-kit :: access (permissions/roles) public contracts")
